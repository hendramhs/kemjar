...
const PlantForm = ({ isOpen, onClose, onSubmit, currentPlant, formData, setFormData }) => {
      ...
      >
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="nextWatering" className="block text-sm font-medium text-gray-700 mb-1">
                Next Watering Date
              </label>
              <input
                type="date"
